...
export class SigninComponent implements OnInit {
    ...
    //    this.messageservice.currentMessage.subscribe(message => this.message = message)
        ...
        // this.userservice.currentUser().subscribe(res =>this.value=res);
        // this.authenticationService.isAdmin().subscribe(res =>this.testadmin=res);   
        
      //  this.userservice.currentUser().subscribe(data=>{console.log(data);this.value=data})
        // this.getWelcomeUser().subscribe(_ => {;
        //   console.log('ngOnit after getUsers() ' + this.value);
        // });
